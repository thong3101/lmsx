		...
		<div class="page-sidebar-wrapper">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					...
					<li>
						<a href="/BanHang/admin/category/manage">
						...
						<ul class="sub-menu">
							...
							<li>
								<a href="/BanHang/admin/sub_category/manage">
					...
					<li>
						<a href="/BanHang/admin/shop/manage">
						<i class="icon-handbag"></i>
					...
					<li>
						<a href="/BanHang/admin/statistic/manage">
					...
					<li>
						<a href="/BanHang/admin/user/manage">
						<i class="icon-user"></i>
					...
					<li class="last ">
						<a href="javascript:;">
						<i class="icon-envelope-open"></i>
						<span class="title">Email Response</span>
						<span class="arrow "></span>
						</a>
					</li>
				</ul>
